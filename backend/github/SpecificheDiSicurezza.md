...
1. Introduzione
   Questo documento definisce la strategia di sicurezza per il sistema gestionale motel. 
   Pur essendo previsto un singolo utente nella prima versione, l'architettura viene predisposta 
   per supportare evoluzioni future (multi-utente, ruoli differenziati).
